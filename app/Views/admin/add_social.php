                        ...
                        <div class="tab-content mt-2" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="lang-tab-0" role="tabpanel">
                                <form id="socialForm" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="icon[1]" class="form-control icon " value="fab fa-facebook">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="link" type="url" name="link" class="form-control  " value="">
                                                <div class="invalid-feedback">
                                                </div>
                                                <div class="valid-feedback"></div>
                                            </div>
                                    ...
                                    <button id="socialBtn" type="button" class="btn waves-effect waves-light btn-rounded btn-primary btn-block mt-3">Save Change</button>
                                </form>
                            </div>
        ...
        $(document).ready(function() {
            $('#socialBtn').click(function() {
                if ($('#name').val() != '' && $('#icon').val() != '' && $('#link').val() != '') {
                    $.ajax({
                        type: 'POST',
                        url: '<?= base_url() ?>' + "/admin/social/addLinks",
