                        ...
                        <div class="accordion" id="accordionExample">
                                    ...
                                    <div
                                        ...
                                        <div class="accordion-body">
                                            Partial Status is when we partially refund the remains of an order. Sometimes for some reasons we are unable to deliver a full order, so we refund you the remaining undelivered amount. Example: You bought an order with quantity 10 000 and charges 10$, let's say we delivered 9 000 and the remaining 1 000 we couldn't deliver, then we will "Partial" the order and refund you the remaining 1000 (1$ in this example.                                        </div>
                                    </div>
                                </div>
                                                            <div class="accordion-item">
                                    ...
                                    <h5 class="accordion-header" id="heading2">
                                        <button
                                            ...
                                            How to get youtube comment link?                                        </button>
                                    </h5>
                                    <div
                                        id="collapse2"
                                        class="accordion-collapse collapse                                         aria-labelledby="heading2"
                                        data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            Find the timestamp that is located next to your username above your comment (for example: "3 days ago") and hover over it then right click and "Copy Link Address". The link will be something like this: https://www.youtube.com/watch?v=12345&amp;lc=a1b21etc instead of just https://www.youtube.com/watch?v=12345 To be sure that you got the correct link, paste it in your browser's address bar and you will see that the comment is now the first one below the video and it says "Highlighted comment".                                        </div>
                                    </div>
                                </div>
                                                            <div class="accordion-item">
                                    <h5 class="accordion-header" id="heading3">
                                        <button
                                            ...
                                            What is 'Instagram Saves', and what does it do?                                        </button>
                                    </h5>
                                    <div
                                        id="collapse3"
                                        class="accordion-collapse collapse                                         aria-labelledby="heading3"
                                        data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            Instagram Saves is when a user saves a post to his history on Instagram (by pressing the save button near the like button). A lot of saves for a post increase its impression.                                        </div>
                                    </div>
                                </div>
                                                            <div class="accordion-item">
                                    <h5 class="accordion-header" id="heading4">
                                        <button
                                            ...
                                            How do I benefit from the ICO Token?                                        </button>
                                    </h5>
                                    <div
                                        id="collapse4"
                                        class="accordion-collapse collapse                                         aria-labelledby="heading4"
                                        data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                    ...
                                    <h5 class="accordion-header" id="heading5">
                                        <button
                                            ...
                                            The link must be added before the user goes live or after?                                        </button>
                                    </h5>
                                    <div
                                        id="collapse5"
                                        class="accordion-collapse collapse                                         aria-labelledby="heading5"
                                        data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
