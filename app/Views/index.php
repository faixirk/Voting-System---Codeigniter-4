        ...
        <div class="skitter skitter-large with-dots">
            <ul>
                        ...
                        <a href="https://script.bugfinder.net/prophecy/">
                            <img
                                src="https://script.bugfinder.net/prophecy/assets/uploads/content/6323220cbcb231663246860.jpg"
                                class="downBars"
                            />
                        </a>
                        ...
                        <a href="https://script.bugfinder.net/prophecy/">
                            <img
                                src="https://script.bugfinder.net/prophecy/assets/uploads/content/63232267df3401663246951.jpg"
                                class="downBars"
                            />
                        </a>
                        <div class="label_text">
                        ...
                        <a href="https://script.bugfinder.net/prophecy">
                            <img
                                src="https://script.bugfinder.net/prophecy/assets/uploads/content/632322b1c7bcb1663247025.jpg"
                                class="downBars"
                            />
                        </a>
                        <div class="label_text">
...
<div class="categories" id="categories">
    ...
    <a href="https://script.bugfinder.net/prophecy/category/football/4"
       class="">
        <i class="far fa-futbol" aria-hidden="true"></i> <span>Football</span>
    </a>
    
    <a href="https://script.bugfinder.net/prophecy/category/cricket/26"
       class="">
        <i class="far fa-cricket" aria-hidden="true"></i> <span>Cricket</span>
    </a>
    
    <a href="https://script.bugfinder.net/prophecy/category/badminton/3"
       class="">
        <i class="far fa-shuttlecock" aria-hidden="true"></i> <span>Badminton</span>
    </a>
    
    <a href="https://script.bugfinder.net/prophecy/category/chess/5"
       class="">
        <i class="far fa-chess" aria-hidden="true"></i> <span>Chess</span>
    </a>
    
    <a href="https://script.bugfinder.net/prophecy/category/basketball/6"
       class="">
        <i class="far fa-basketball-ball" aria-hidden="true"></i> <span>Basketball</span>
    </a>
    
    <a href="https://script.bugfinder.net/prophecy/category/hockey/7"
       class="">
            ...
            <div class="modal-body">
                <form class="login-form" id="signup-form" action="https://script.bugfinder.net/prophecy/register" method="post">
                    ...
                    <div class="bottom">
                        ...
                        <a href="https://script.bugfinder.net/prophecy/login">Login here</a>
                    </div>
                </form>
            </div>
        </div>
